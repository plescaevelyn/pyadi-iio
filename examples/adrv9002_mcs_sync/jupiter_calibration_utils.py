...
#     plt.title('Constellation Plot Tx')
    ...
    time.sleep(1) # wait for internal calibrations
    # Adjust phase
    rx_samples = adjust_phase(sdrs, 0, rx_samples[0], rx_samples[1], rx_samples[2], rx_samples[3])
...
#     plt.title('Constellation Plot Tx')
    ...
    # Adjust Gain
    rx_samples = adjust_gain(sdrs, rx_samples[0], rx_samples[1], rx_samples[2], rx_samples[3])
    ...
    sdrs.pcal = [avg_ph_diff_ch0_minus_ch1, avg_ph_diff_ch0_minus_ch2, avg_ph_diff_ch0_minus_ch3]
