...
if TEMP_OFF >= TEMP_ON:
    raise ValueError(f"Invalid hysteresis: TEMP_OFF ({TEMP_OFF}) must be < TEMP_ON ({TEMP_ON}).")
...
def read_tmp01_temperature():
    ...
    voltage_raw = (board_temp.ad74413r.channel["voltage3"].raw *
...
try:
    ...
    print("Temperature Board AD74413R input channels:", board_temp.ad74413r._rx_channel_names)
    print("Fan Control Board MAX14906 channels:", board_fan.max14906._tx_channel_names, board_fan.max14906._rx_channel_names)
